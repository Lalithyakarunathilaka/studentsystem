...
>
  <br></br> <br></br>
        <h4 className="mb-4">Student Dashboard</h4> <br></br>
        <ul className="nav flex-column">
          <li className="nav-item mb-4">
            <Link to="/student/dashboard" className="nav-link text-white">Dashboard</Link>
          </li>
          <li className="nav-item mb-4">
            <Link to="/student/marks" className="nav-link text-white">View Marks</Link>
          </li>
          <li className="nav-item mb-4">
